...
if __name__ == "__main__":
    ...
    gas.transport_model = 'UnityLewis'
    sim.transport_model = 'UnityLewis'
    ...
    sim.write_csv(
        data_directory +
        '{0}-qDilu_{1:.4f}-Zst_{2:.4f}-Premixed-UnityLewis.csv'.format(diluent, qDilu, Zst),
        species='Y')
    ...
    # sim.show_stats
    dataSaveDir = data_directory + '{0}-qDilu_{1:.4f}-Zst_{2:.4f}-Premixed-UnityLewis'.format(diluent, qDilu, Zst)
    ...
    gasF.TPY = Tin, Pin, Y1
    gasF.transport_model = 'UnityLewis'
    rhoF = gasF.density
    ...
    gasO.TPY = Tin, Pin, Y2
    gasO.transport_model = 'UnityLewis'
    rhoO = gasO.density
