...
if __name__ == "__main__":
    ...
    print(
        '// LeF = {0:.3f}, LeO = {1:.3f}, phou = {2:.3f}, rhob = {3:.3f}, alpha = {4:.3f}, Tf = {5:.3f}.'
        .format(
            LeX[iFuel],
            LeX[iOxid],
            rhou,
    ...
    sim.set_max_jac_age(
        50, 50)  # Max number of times the Jacobian before re-evaluated
    ...
    sim.write_csv(data_directory +
                  'phiS_{0:.2f}-qDF_{1:.2f}-Premixed.csv'.format(phiS, qDF),
                  species='Y')
