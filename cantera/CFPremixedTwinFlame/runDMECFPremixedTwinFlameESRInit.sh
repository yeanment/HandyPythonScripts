#!/bin/bash
python CFPremixedTwinFlame/CFPremixedTwinFlameESRInitial.py \
       --Mech chem/DME_LuChen2015/DME_LuChen2015.xml \
       --Fuel CH3OCH3 --EquivalenceRatio 1.0 --TransportModel Mix \
       --Tin 700 --InitialFile data/CFPremixedTwinFlame/Y0.01_000001.csv \

#       > data/CFPremixedTwinFlame/log.DMEAir_phi1.0_Mix_Tu700_Init 2>& 1
